...
import InstancedPeriwinkles from "../instances/instanced-periwinkles";

type PeriwinklesTileProps = {
...
const PeriwinklesTile: FC<PeriwinklesTileProps> = ({ instances, size }) => {
...
export default PeriwinklesTile;
